...
CREATE TABLE IF NOT EXISTS `barang` (
  ...
  `model_prediksi` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `p` int DEFAULT NULL,
  `d` int DEFAULT NULL,
  `q` int DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `pembayaran_hutang` (
  ...
  `no_invoice` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `penjualan` (
  ...
  `top` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `id_customer` (`id_customer`),
  CONSTRAINT `FK_penjualan_id_customer` FOREIGN KEY (`id_customer`) REFERENCES `customer` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14090 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=27066 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
